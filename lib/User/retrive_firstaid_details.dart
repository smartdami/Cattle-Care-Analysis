...
import 'package:cattle_care_analysis/Detail_Page/FirstAid_Details_Screen.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:firebase_database/ui/firebase_animated_list.dart';
import 'package:flutter/material.dart';
import 'dart:ui' as ui;
class ret_firstaid_det extends StatefulWidget {
  @override
  _ret_firstaid_detState createState() => _ret_firstaid_detState();
}

class _ret_firstaid_detState extends State<ret_firstaid_det> {
                  ...
                  onTap: () {
                    ...
                    if (index == 3) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => Rabbitdet(sColor: items[index].startColor,eColor: items[index].endColor)),
                      );
                    }
                    if (index == 4) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => Hen(sColor: items[index].startColor,eColor: items[index].endColor)),
                      );
                    }
                  },
                  child: Container(
      ...
      body: SafeArea(
        child: Container(
          child: FirebaseAnimatedList(
            shrinkWrap: true,
            query: FirebaseDatabase.instance.reference().child("FirstAid")
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(
                      builder: (context) =>
                          FirstAid_Details_Screen(sColor: widget.sColor,
...
class Rabbitdet extends StatefulWidget {
  final Color sColor,eColor;

  const Rabbitdet({Key key, this.sColor, this.eColor}) : super(key: key);
  @override
  _RabbitdetState createState() => _RabbitdetState();
}

class _RabbitdetState extends State<Rabbitdet> {
  final double _borderRadius = 24;
