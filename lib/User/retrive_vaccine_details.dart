...
import 'package:cattle_care_analysis/Detail_Page/Vaccine_Details_Screen.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:firebase_database/ui/firebase_animated_list.dart';
import 'package:flutter/material.dart';
import 'dart:ui' as ui;
class retvaccdet extends StatefulWidget {
  @override
  _retvaccdetState createState() => _retvaccdetState();
}

class _retvaccdetState extends State<retvaccdet> {
      ...
      body: SafeArea(
        child: Container(
          child: FirebaseAnimatedList(
            shrinkWrap: true,
            query: FirebaseDatabase.instance.reference().child("VaccinationDetails")
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(
                      builder: (context) =>
                          Vaccine_Details_Screen(sColor: widget.sColor,
                            eColor: widget.eColor,
                            VaccineName:dis['VaccineName'],
                            DiseaseName: dis['DiseaseName'],
                            VaccinePeriod: dis['VaccinePeriod'],)));
                },
                child: Container(
                  child: Center(
                    child: Padding(
